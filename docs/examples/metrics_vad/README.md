...
This example shows how to use the VAD metrics to log metrics to the console.
...
- Using the VAD metrics to log metrics to the console.
- {'This includes': ['Idle Time', 'Inference Duration Total', 'Inference Count', 'Speech ID', 'Error']}
...
from livekit.agents import JobContext, WorkerOptions, cli, Agent, AgentSession, inference, vad
